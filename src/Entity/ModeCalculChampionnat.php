...
#[ORM\Entity(repositoryClass: ModeCalculChampionnatRepository::class)]
class ModeCalculChampionnat
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'modeCalculChampionnat', targetEntity: ReglementChampionnat::class)]
    ...
    public function addReglementChampionnat(ReglementChampionnat $reglementChampionnat): static
    {
        if (!$this->reglementChampionnat->contains($reglementChampionnat)) {
            ...
            $reglementChampionnat->setModeCalculChampionnat($this);
        }
    ...
    public function removeReglementChampionnat(ReglementChampionnat $reglementChampionnat): static
    {
        if ($this->reglementChampionnat->removeElement($reglementChampionnat)) {
            ...
            if ($reglementChampionnat->getModeCalculChampionnat() === $this) {
                $reglementChampionnat->setModeCalculChampionnat(null);
            }
        }
